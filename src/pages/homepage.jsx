    ...
    <HeroSection />
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
          <div className="bg-white shadow-lg">
            ...
            <div className="p-4">
              <h3 className="font-bold">Escape Memories</h3>
              <p className="text-sm">Music Festival • 12 Dec 2025</p>
            </div>
             </div>
        </section>
         <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
          <div className="bg-white shadow-lg">
            <img src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/3ccfc6150314037.62f7d34c3a8b9.jpg" alt="Event 1" className="w-full h-40 object-cover" />
            <div className="p-4">
              <h3 className="font-bold">Escape Memories</h3>
              <p className="text-sm">Music Festival • 12 Dec 2025</p>
            </div>
